  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center pointer-events-auto">
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute right-4 top-4 z-20 flex size-10 items-center justify-center rounded-full bg-white/5 text-white backdrop-blur-md transition-colors hover:bg-white/10"
        >
          <X className="size-5" />
        </button>
          ...
          <div className="relative h-64 sm:h-[420px] w-full overflow-hidden group bg-[#111111]">
            ...
            {carouselImages.length > 1 && (
              <>
                <button
                  onClick={prevImage}
                  className="absolute left-4 sm:left-6 top-1/2 -translate-y-1/2 flex size-10 sm:size-12 items-center justify-center rounded-full bg-white/5 text-white backdrop-blur-md opacity-100 sm:opacity-0 transition-all sm:group-hover:opacity-100 hover:bg-white/10 hover:scale-110"
                >
                  <ChevronLeft className="size-6 sm:size-8" />
                </button>
                <button
                  onClick={nextImage}
                  className="absolute right-4 sm:right-6 top-1/2 -translate-y-1/2 flex size-10 sm:size-12 items-center justify-center rounded-full bg-white/5 text-white backdrop-blur-md opacity-100 sm:opacity-0 transition-all sm:group-hover:opacity-100 hover:bg-white/10 hover:scale-110"
                >
